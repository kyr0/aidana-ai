...
export const mcpMeta: McpToolMeta = {
  workItemType: "116117_arztsuche",
  name: "116117_arztsuche",
  description:
    "Search the German 116117 doctor directory (arztsuche.116117.de) for doctors by specialty and location.",
  inputSchema: {
    type: "object",
    properties: {
      query: {
        type: "string",
        description:
          'Medical specialty or doctor name, e.g. "Psychiatrie und Psychotherapie"',
      },
      place: {
        type: "string",
