export type WorkItemType = "google_search" | "116117_arztsuche" | "scrape" | "download_file";
...
/** MCP tool metadata — each tool exports one of these for auto-discovery */
export interface McpToolMeta {
  /** Must match the WorkItemType used by the tool */
  workItemType: WorkItemType;
  /** MCP tool name exposed to the LLM */
  name: string;
